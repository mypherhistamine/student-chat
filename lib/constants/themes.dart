...
class ThemeConstants
{
  ...
  static const ROOMS_MENU_TEXT_STYLE = TextStyle(color: Colors.black,fontSize: 20,fontWeight:FontWeight.w800,fontFamily: 'PS');

  static const Color MENU_NOT_SELECTED = Color(0xFF555555);

  static const LinearGradient PURPLE_GRADIENT = LinearGradient(colors: [Color(0xFF4E57F2),Color(0xFF973FF5)],begin: Alignment.topLeft,end: Alignment.bottomRight);
  static const LinearGradient WHITE_GRADIENT = LinearGradient(colors: [Colors.transparent,Colors.transparent],);
